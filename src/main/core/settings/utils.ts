...
export function assertNoKeyboardShortcutConflicts(keyboard?: KeyboardSettings): void {
  if (!keyboard) return;
...
export function deepMerge<T extends Record<string, any>>(base: T, partial?: Partial<T>): T {

import type { AgentSessionConfig } from '../workspaces/impl/agent-provider/agent-session';
import type { GeneralSessionConfig } from '../workspaces/impl/terminal-provider/general-session';

import type { AgentSessionConfig } from '../environment/impl/agent-provider/agent-session';
import type { GeneralSessionConfig } from '../environment/impl/terminal-provider/general-session';

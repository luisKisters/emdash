...
export const FileIconType = {
  ...
  TypeScript: () => (
    <svg viewBox="0 0 16 16" className="h-4 w-4 flex-shrink-0">
      ...
      <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="white" fontSize="10" fontWeight="bold">TS</text>
    </svg>
  ),
  ...
  React: () => (
    <svg viewBox="0 0 16 16" className="h-4 w-4 flex-shrink-0">
      ...
      <ellipse cx="8" cy="8" rx="5" ry="2" fill="none" stroke="#282c34" strokeWidth="0.8" transform="rotate(60 8 8)"/>
      <ellipse cx="8" cy="8" rx="5" ry="2" fill="none" stroke="#282c34" strokeWidth="0.8" transform="rotate(-60 8 8)"/>
    </svg>
  ),
  ...
  JavaScript: () => (
    <svg viewBox="0 0 16 16" className="h-4 w-4 flex-shrink-0">
      ...
      <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="#323330" fontSize="10" fontWeight="bold">JS</text>
    </svg>
  ),
  ...
  JSON: () => (
    <svg viewBox="0 0 16 16" className="h-4 w-4 flex-shrink-0">
      ...
      <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="#fbc02d" fontSize="5" fontWeight="bold">{`{}`}</text>
    </svg>
  ),
  ...
  CSS: () => (
    <svg viewBox="0 0 16 16" className="h-4 w-4 flex-shrink-0">
      ...
      <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="white" fontSize="7" fontWeight="bold">CSS</text>
    </svg>
  ),
  ...
  SCSS: () => (
    <svg viewBox="0 0 16 16" className="h-4 w-4 flex-shrink-0">
      ...
      <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="white" fontSize="6" fontWeight="bold">SCSS</text>
    </svg>
  ),
  ...
  HTML: () => (
    <svg viewBox="0 0 16 16" className="h-4 w-4 flex-shrink-0">
      ...
      <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="white" fontSize="5" fontWeight="bold">HTML</text>
    </svg>
  ),
  ...
  Markdown: () => (
    <svg viewBox="0 0 16 16" className="h-4 w-4 flex-shrink-0">
      ...
      <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="white" fontSize="8" fontWeight="bold">M↓</text>
    </svg>
  ),
  ...
  Git: () => (
    <svg viewBox="0 0 16 16" className="h-4 w-4 flex-shrink-0">
      ...
      <path d="M8 4L4 8l4 4M8 4l4 4-4 4" stroke="white" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
    </svg>
  ),
  ...
  Python: () => (
    <svg viewBox="0 0 16 16" className="h-4 w-4 flex-shrink-0">
      ...
      <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="#ffd43b" fontSize="8" fontWeight="bold">Py</text>
    </svg>
  ),
  ...
  YAML: () => (
    <svg viewBox="0 0 16 16" className="h-4 w-4 flex-shrink-0">
      ...
      <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="white" fontSize="6" fontWeight="bold">YAML</text>
    </svg>
  ),
  ...
  ENV: () => (
    <svg viewBox="0 0 16 16" className="h-4 w-4 flex-shrink-0">
      ...
      <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="#333" fontSize="6" fontWeight="bold">.env</text>
    </svg>
  ),
  ...
  File: () => (
    <svg viewBox="0 0 16 16" className="h-4 w-4 flex-shrink-0">
      <path d="M10 2H4C3.45 2 3 2.45 3 3V13C3 13.55 3.45 14 4 14H12C12.55 14 13 13.55 13 13V5L10 2Z"
            fill="#9ca3af"/>
  ...
  Shell: () => (
    <svg viewBox="0 0 16 16" className="h-4 w-4 flex-shrink-0">
      ...
      <text x="3" y="10" fill="#4ec9b0" fontSize="8" fontFamily="monospace">$_</text>
    </svg>
  ),
...
export const FileIcon = ({ filename, isDirectory, isExpanded = false }: { filename: string; isDirectory: boolean; isExpanded?: boolean }) => {
  if (isDirectory) {

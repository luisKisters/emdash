...
export const FileIcon: React.FC<FileIconProps> = ({
  ...
  const specialFiles: Record<string, React.ReactElement> = {
    ...
    '.env.production': <VscSettingsGear {...iconProps} className={`${className} text-yellow-600`} />,
    '.env.development': <VscSettingsGear {...iconProps} className={`${className} text-yellow-600`} />,
    ...
    'next.config.js': <SiNextdotjs {...iconProps} className={`${className} text-gray-800 dark:text-white`} />,

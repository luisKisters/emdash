import { ArrowUp, ArrowUpRight, CheckCircle2, Loader2, X, XCircle } from 'lucide-react';
...
import { formatRelativeTime, type PrComment } from '@renderer/lib/github';
import { useCheckRuns } from '../../state/use-check-runs';
import { usePrComments } from '../../state/use-pr-comments';
import { ChecksList } from './pr-checks-list';

...
export const APP_SHORTCUTS = defineShortcuts({
  ...
  tab1: { defaultHotkey: 'Mod+1', label: 'Tab 1', description: 'Switch to tab 1', category: 'Tab Navigation', hideFromSettings: true },
  tab2: { defaultHotkey: 'Mod+2', label: 'Tab 2', description: 'Switch to tab 2', category: 'Tab Navigation', hideFromSettings: true },
  tab3: { defaultHotkey: 'Mod+3', label: 'Tab 3', description: 'Switch to tab 3', category: 'Tab Navigation', hideFromSettings: true },
  tab4: { defaultHotkey: 'Mod+4', label: 'Tab 4', description: 'Switch to tab 4', category: 'Tab Navigation', hideFromSettings: true },
  tab5: { defaultHotkey: 'Mod+5', label: 'Tab 5', description: 'Switch to tab 5', category: 'Tab Navigation', hideFromSettings: true },
  tab6: { defaultHotkey: 'Mod+6', label: 'Tab 6', description: 'Switch to tab 6', category: 'Tab Navigation', hideFromSettings: true },
  tab7: { defaultHotkey: 'Mod+7', label: 'Tab 7', description: 'Switch to tab 7', category: 'Tab Navigation', hideFromSettings: true },
  tab8: { defaultHotkey: 'Mod+8', label: 'Tab 8', description: 'Switch to tab 8', category: 'Tab Navigation', hideFromSettings: true },
  tab9: { defaultHotkey: 'Mod+9', label: 'Tab 9', description: 'Switch to tab 9', category: 'Tab Navigation', hideFromSettings: true },
  newConversation: {

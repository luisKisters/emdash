...
Some features that work locally are not yet available for remote projects:

- Staging/unstaging individual files in the UI
- Live file diffs and status updates
- Branch rename and worktree merge via UI

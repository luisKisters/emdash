...
<div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '48px', margin: '32px 0' }}>
  <img src="/media/logo-aws.png" alt="AWS" style={{ height: '40px', objectFit: 'contain' }} />
  <img src="/media/logo-hetzner.png" alt="Hetzner" style={{ height: '40px', objectFit: 'contain' }} />

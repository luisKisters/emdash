...
Emdash supports 23 coding agent CLIs. Install any of them and Emdash detects it automatically.
...
| Junie CLI      | `curl -fsSL https://junie.jetbrains.com/install.sh \| bash`                                  |

/**
 * Chat/Projected/Blocks — per-block stories for style iteration.
 *
...
export const Image = makeStory('![A sample image](https://picsum.photos/seed/chat/400/200)');

export const GenericIsland = makeStory(
  '```mermaid\ngraph TD\n  A[Start] --> B[Process]\n  B --> C[End]\n```'
);

export const MultipleBlocks = makeStory(

/**
 * Fixture-driven snapshot tests for OpenCode ACP transcript parsing.
 *
 * OpenCode speaks ACP natively over stdio, so this exercises the parser's
 * baseline decoding without a provider-specific enrichment hook.
 */
...
describe('OpenCode ACP fixture parsing', () => {
  it('transcript', () => {

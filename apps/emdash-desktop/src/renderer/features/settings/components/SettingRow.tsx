...
export function SettingRow({ title, description, control, className, searchId }: SettingRowProps) {
  const id = searchId ?? (typeof title === 'string' ? slugifySettingLabel(title) : undefined);
